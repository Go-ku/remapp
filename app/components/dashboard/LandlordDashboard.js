...
export default function LandlordDashboard({ stats }) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="py-4">
          <h2 className="text-sm text-muted-foreground">My Properties</h2>
          <p className="text-2xl font-bold">{stats.properties}</p>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="py-4">
          <h2 className="text-sm text-muted-foreground">Active Tenants</h2>
